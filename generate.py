...
def main():
    ...
    writeData = {"imgList":imgList,"flatMean":flatMean,"demeanedImages":demeanedImages,"eigenVectors":pcaEigenVectors, "trainingDistances":trainingDistances, "threshold":threshold}
